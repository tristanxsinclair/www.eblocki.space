...
export const DOMAIN_STANDARD_REGISTRY: Record<DomainStandardKey, DomainStandard> = {
  law_irac_standard: {
    ...
    requiredEvidence: ["issue", "rule", "authority", "application", "conclusion"],
  ...
  law_source_bank_standard: {
    ...
    requiredEvidence: ["source name", "jurisdiction", "authority level", "key rule", "assessment use"],
  ...
  academic_proof_plan_standard: {
    ...
    requiredEvidence: ["unit objective", "artifact cadence", "source strategy", "first artifact"],
  ...
  product_system_review_standard: {
    ...
    requiredEvidence: ["specific issue", "actual output evidence", "corrected logic", "implementation path", "measurable test"],
  ...
  eblocki_implementation_standard: {
    ...
    requiredEvidence: ["files changed", "logic implemented", "tests", "build/test result", "behaviour improved"],
  ...
  general_proof_standard: {
    ...
    requiredEvidence: ["visible artifact", "applied detail", "feedback", "next upgrade"],

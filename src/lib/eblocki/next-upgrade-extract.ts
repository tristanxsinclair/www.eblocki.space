...
export const NEXT_UPGRADE_MAX_CHARS = 280;

export interface NextUpgradeInput {
...
function cap(value: string, max = NEXT_UPGRADE_MAX_CHARS): string {
...
export function extractNextUpgrade(input: NextUpgradeInput): string {

...
const PROOF_LOOP = [
  ...
  },
  {
    ...
    body: "Your record only moves after real evidence is filed and judged. Nothing is handed out for good intentions.",
  },
  {
    icon: Bot,
    label: "05",
          ...
          <div className="container grid gap-8 py-12 md:grid-cols-[minmax(0,1fr)_minmax(360px,0.9fr)] md:items-center md:py-20 lg:py-24">
            <div className="max-w-3xl">
              ...
              <p className="operator-body mt-6 max-w-xl md:text-lg">
                ...
                judges it honestly, and gives you one next move. Your record is built from real
              ...
              >
                ...
                <Button asChild size="lg" variant="outline" className="w-full sm:w-auto">
                  <Link to="/why">Why proof works</Link>
                </Button>
                <Button asChild size="lg" variant="ghost" className="w-full sm:w-auto">
                  <a href="#how-proof-works">
...
No proof, no progress — that is the whole rule
        ...
        <section id="how-proof-works" className="operator-section">
          <div className="container grid gap-8 md:grid-cols-[0.8fr_1.2fr] md:items-start">
            ...
            <div className="space-y-3">
              <EvidenceRule
                ...
                body="There is no shortcut around proof. Tasks that need evidence send you to log the real artifact instead."
              />
              <EvidenceRule
              ...
              <EvidenceRule
                ...
                body="You can study and practise as much as you like. Progress only counts once evidence is filed and judged."
              />
            </div>
          </div>
        </section>
        ...
        <section className="operator-section">
          <div className="container grid gap-4 md:grid-cols-2">
            ...
            <Card className="operator-panel p-6 sm:p-8">
              ...
              <h2 className="mt-2 text-2xl font-semibold">Personal to your subjects.</h2>
              <p className="mt-3 leading-7 text-muted-foreground">
                Your profile keeps roles, goals, study areas, and proof history in one place so
                Eblocki can keep today relevant.
              </p>
            </Card>
          </div>
        </section>
          ...
          <div className="container text-center">
            <div className="mx-auto max-w-2xl">
              ...
              <p className="mt-4 text-muted-foreground">
                Start for free and log your first proof in under two minutes. Free forever, open source, no ads.
              </p>
              <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
                ...
                <Button asChild size="lg" variant="outline" className="w-full sm:w-auto">
                  <Link to="/why">See why it works</Link>
                </Button>
              </div>
            </div>
          </div>
    ...
    <Card className="operator-panel-accent overflow-hidden">
      <div className="border-b border-border bg-primary/[0.04] px-4 py-3">
        <div className="flex items-center justify-between gap-3 font-mono text-[9px] uppercase tracking-[0.2em]">
          <span className="text-primary">Student profile</span>
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-1 text-xl font-semibold">Psychology + Law</h2>
          </div>
        ...
        <div className="mt-5 rounded-sm border border-primary/30 bg-primary/[0.04] p-4">
          ...
          <div className="mt-2 font-semibold">Submit one timed answer paragraph</div>
          <div className="mt-3 rounded-sm border border-border bg-background/50 p-3">
            <div className="font-mono text-[8px] uppercase tracking-widest text-muted-foreground">
              Evidence required
            </div>
            <p className="mt-1 text-xs text-foreground">Answer paragraph + marked weak line</p>
          </div>
        </div>
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-2">
          ...
          <PreviewPanel
            icon={ScrollText}
            label="Proof record"
            value="Strong proof // next correction selected"
          />
        </div>
      </div>
    </Card>

...
exports.humaniseModeId = humaniseModeId;
exports.isStudyDomain = isStudyDomain;
...
function humaniseModeId(id, fallbackDisplayName) {
    ...
    if (upper in EXTRA_LABELS)
        return EXTRA_LABELS[upper];
    if (upper in modes_1.MODE_LABELS)
        return modes_1.MODE_LABELS[upper];

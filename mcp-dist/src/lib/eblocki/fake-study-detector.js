...
exports.STUDY_VERDICT_COPY = void 0;
exports.classifyStudyActivity = classifyStudyActivity;
exports.STUDY_VERDICT_COPY = {
...
function tierVerdict(signal) {
    if (signal.startsWith("elite"))
        return "elite";
    if (signal.startsWith("strong"))
        return "strong";
    if (signal.startsWith("useful"))
        return "useful";
    if (signal === "fallback_action")
        return "useful";
    return "weak";
}
...
function classifyStudyActivity(input) {
    ...
    return {
        verdict,
        reason,
        verdictCopy: exports.STUDY_VERDICT_COPY[verdict],
        upgradeCommand,

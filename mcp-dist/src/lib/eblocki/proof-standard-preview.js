...
function stableArtifactHint(value) {
    ...
    if (text.includes("source bank") || text.includes("authority"))
        return "source-bank entries";
    if (text.includes("irac") || text.includes("problem answer"))
        return "IRAC paragraph";
    if (text.includes("product") || text.includes("router") || text.includes("logic"))
        return "product system review";
    if (text.includes("implementation") || text.includes("test result"))
        return "implementation proof";
    if (text.includes("academic") || text.includes("mastery") || text.includes("study"))
        return "academic proof plan";
